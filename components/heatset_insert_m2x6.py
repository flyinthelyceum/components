"""heatset_insert_m2x6: brass heat-set insert, M2 thread, 6 mm nominal length.

From the lyceum's box, measured 2026-09-18. The vendor labels this
"M2 x 6 x 3.5mm", i.e. thread x length x BODY diameter.
...
"""
UNIT = "mm"
OD = 3.556  # CALIPER 2026-09-18 JR
LENGTH = 6.121  # CALIPER 2026-09-18 JR
