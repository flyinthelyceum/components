"""heatset_insert_m4x4: brass heat-set insert, M4 thread, 4 mm nominal length.

From the lyceum's box, measured 2026-09-18. The vendor labels this
"M4 x 4 x 6mm", i.e. thread x length x BODY diameter.
...
"""
UNIT = "mm"
OD = 6.477  # CALIPER 2026-09-18 JR
LENGTH = 4.14  # CALIPER 2026-09-18 JR
