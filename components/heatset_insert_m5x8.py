"""heatset_insert_m5x8: brass heat-set insert, M5 thread, 8 mm nominal length.

From the lyceum's box, measured 2026-09-18. The vendor labels this
"M5 x 8 x 7mm", i.e. thread x length x BODY diameter.
...
"""
UNIT = "mm"
OD = 7.391  # CALIPER 2026-09-18 JR
LENGTH = 8.179  # CALIPER 2026-09-18 JR
