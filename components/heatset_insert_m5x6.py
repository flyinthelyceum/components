"""heatset_insert_m5x6: brass heat-set insert, M5 thread, 6 mm nominal length.

From the lyceum's box, measured 2026-09-18. The vendor labels this
"M5 x 6 x 7mm", i.e. thread x length x BODY diameter.

OD HERE IS OVER THE KNURL, which is what a boss has to be sized to, and the knurl
stands proud of the body figure on the label - about 0.42 mm on M5.
...
"""
UNIT = "mm"
OD = 7.493  # CALIPER 2026-09-18 JR
LENGTH = 6.274  # CALIPER 2026-09-18 JR
