"""heatset_insert_m3x6: brass heat-set insert, M3 thread, 6 mm nominal length.

From the lyceum's box, measured 2026-09-18. The vendor labels this
"M3 x 6 x 5mm", i.e. thread x length x BODY diameter.
...
LENGTH = 6.07  # CALIPER 2026-09-18 JR
