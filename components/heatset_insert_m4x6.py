"""heatset_insert_m4x6: brass heat-set insert, M4 thread, 6 mm nominal length.

From the lyceum's box, measured 2026-09-18. The vendor labels this
"M4 x 6 x 6mm", i.e. thread x length x BODY diameter.

OD HERE IS OVER THE KNURL, which is what a boss has to be sized to, and the knurl
stands proud of the body figure on the label - about 0.42 mm on M4.
...
"""
UNIT = "mm"
OD = 6.401  # CALIPER 2026-09-18 JR
LENGTH = 6.248  # CALIPER 2026-09-18 JR
