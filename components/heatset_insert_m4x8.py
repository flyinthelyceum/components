"""heatset_insert_m4x8: brass heat-set insert, M4 thread, 8 mm nominal length.

From the lyceum's box, measured 2026-09-18. The vendor labels this
"M4 x 8 x 6mm", i.e. thread x length x BODY diameter.
...
LENGTH = 8.077  # CALIPER 2026-09-18 JR
