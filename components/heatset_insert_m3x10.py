"""heatset_insert_m3x10: brass heat-set insert, M3 thread, 10 mm nominal length.

From the lyceum's box, measured 2026-09-18. The vendor labels this
"M3 x 10 x 5mm", i.e. thread x length x BODY diameter.

OD HERE IS OVER THE KNURL, which is what a boss has to be sized to, and the knurl
stands proud of the body figure on the label - about 0.42 mm on M3.
...
LENGTH = 10.033  # CALIPER 2026-09-18 JR
