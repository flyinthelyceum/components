"""heatset_insert_m2x8: brass heat-set insert, M2 thread, 8 mm nominal length.

From the lyceum's box, measured 2026-09-18. The vendor labels this
"M2 x 8 x 3.5mm", i.e. thread x length x BODY diameter.
...
"""
UNIT = "mm"
OD = 3.505  # CALIPER 2026-09-18 JR
LENGTH = 7.874  # CALIPER 2026-09-18 JR
