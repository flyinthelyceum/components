"""heatset_insert_m2x10: brass heat-set insert, M2 thread, 10 mm nominal length.

From the lyceum's box, measured 2026-09-18. The vendor labels this
"M2 x 10 x 3.5mm", i.e. thread x length x BODY diameter.
...
LENGTH = 10.287  # CALIPER 2026-09-18 JR
